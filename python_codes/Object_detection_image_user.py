...
np.savetxt('array_boxes1.csv', np.squeeze(boxes), delimiter=',', fmt='%2.4f')
np.savetxt('array_confidence1.csv', np.squeeze(scores), delimiter=',', fmt='%2.4f')
np.savetxt('array_classes1.csv', np.squeeze(classes).astype(np.int32), delimiter=',', fmt='%2d')
